...
namespace Company.Test.DAL.Data.Migrations
{
    ...
    [Migration("20240926223818_AddIdentityUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Company.Test.DAL.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Company.Test.DAL.Models.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Company.Test.DAL.Models.Employee", b =>
                {
                    b.HasOne("Company.Test.DAL.Models.Department", "Workfor")
                        .WithMany("MyProperty")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Company.Test.DAL.Models.ApplicationUser", null)
                        .WithMany()
